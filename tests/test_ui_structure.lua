...
assertContains('"Show raid reset panel", "showRaidInfoPanel", -364, 326, 260', "raid reset checkbox placement")
assertContains('reminderLabel:SetPoint("TOPLEFT", frame, "TOPLEFT", 326, -292)', "ready reminders placement")
